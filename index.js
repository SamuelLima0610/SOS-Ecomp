...
const ThereIsResult = require('./ThereIsResult');
...
async function main(){
    ...
    let calculo = await reader.read('./CALCULO_novo.csv')
    ...
    let join = await Join.join(computationFinale);
